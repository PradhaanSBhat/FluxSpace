...
EDIT_PROMPT="female" # Edit Prompt to guide editing
EDIT_TOKEN="female"  # Edit token for Fine FluxSpace Editing
EDIT="fine" # Edit Type - Coarse, Fine, Both
...
EDIT_ITERATION=2 # Edit iteration for applying fine FluxSpace Editing
