...
DIR="$PWD/Outputs/Flux Human Edits" # Dir should be the directory containing images or the immediate parent directory that contains directories containing images
